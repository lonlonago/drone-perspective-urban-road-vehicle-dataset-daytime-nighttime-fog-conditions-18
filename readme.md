# Drone perspective urban road vehicle dataset daytime nighttime fog conditions 18600

# Body

Drone-View, Urban Road Vehicle Dataset with Day, Night, and Foggy Conditions
18600 images, YOLO format supported, clear images, well-annotated, suitable for drone vehicle detection, autonomous driving, intelligent transportation, large data volume, ready for model training, research, experiments.
photos will be sent instantly upon purchase， .
